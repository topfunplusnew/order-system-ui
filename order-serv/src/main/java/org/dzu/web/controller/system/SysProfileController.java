...
import org.dzu.common.utils.file.FileUploadUtils;
import org.dzu.common.utils.file.MimeTypeUtils;
import org.dzu.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(OrderConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
