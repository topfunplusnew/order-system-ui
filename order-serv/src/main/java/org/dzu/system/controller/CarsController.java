...
public class CarsController extends BaseController
{
    ...
    @Log(title = "外部车辆信息", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "外部车辆信息", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "外部车辆信息", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
