	...
	<div>
		...
		<el-row>
			...
			<el-col :span="18">
				...
				<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" title="流程审核" :visible.sync="checkPaymentApplyDialogVisible" width="65%" append-to-body>
					<!--   需要展示的对应的表信息-->
