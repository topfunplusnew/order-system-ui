<template>
	<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false" title="订单历史对比信息" :visible.sync="checkHistoryOrderVisible" width="1100px">
		<el-row>
