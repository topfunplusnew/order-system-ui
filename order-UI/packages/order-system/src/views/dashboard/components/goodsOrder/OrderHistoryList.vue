...
<template>
	<div>
		<el-table id="printBox" v-horizontal-scroll="'always'" fit border :data="filteredGoodsOrderList" max-height="462px"
			empty-text="暂无修改记录（一天内修改订单不会记录修改原因）" size="mini" :cell-style="
								() => {
									return { padding: '2px' };
								}
							">
