...
export default {
	...
	computed: {
		computedValue() {
			return this.orderItemInfo.supplier === undefined ||
	...
	<div>
		<el-card class="box-card">
			<div slot="header" class="clearfix">
				<span style="font-weight: bold; color: #1ab394"
					>货物信息({{ index + 1 }})</span
				>
				<slot name="action" />
			</div>
			<div class="order font-size-12">
				...
				<div class="order-item">
					...
					<hr />
					<el-radio
						v-model="orderItemInfo.isIncludeTaxFactory"
						:label="1"
						>是
					</el-radio>
					<el-radio
				...
				<div class="order-item">
					...
					<hr />
					<el-radio
						v-model="orderItemInfo.isIncludeTaxSale"
						:label="1"
						>是
					</el-radio>
					<el-radio
          ...
          <el-input v-model="orderItemInfo.actualPieces" type="text" placeholder="实际片数" />
				...
				<div class="order-item">
					...
					<hr />
					<el-input
						v-model="orderItemInfo.logisticsProfit"
						type="text"
						placeholder="物流利润"
					/>
				</div>
