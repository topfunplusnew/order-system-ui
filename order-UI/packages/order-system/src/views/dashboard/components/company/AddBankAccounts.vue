...
<template>
	<div>
		...
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight  title="提示" :visible.sync="dialogVisible" width="30%" append-to-body :close-on-click-modal="false" :close-on-press-escape="false">
			<div>
