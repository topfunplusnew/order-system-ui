<template>
	<div class="app-container">
		...
		<!-- 调度日志详细 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="调度日志详细" :visible.sync="open" width="700px" append-to-body>
