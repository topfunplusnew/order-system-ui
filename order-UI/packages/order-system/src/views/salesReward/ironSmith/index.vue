...
import { checkOrderByOrderNo, getGoodsOrder, listGoodsOrder } from '@/api/system/goodsOrder';
...
export default {
	...
	methods: {
		...
		handleExport() {
			...
			this.download('system/salesReward/export', exportParams, `铁匠奖励_${new Date().getTime()}.xlsx`);
		}
	}
};
</script>
