<template>
	<div class="freight-info">
		...
		<div class="search-area">
			<el-form :inline="true" :model="searchForm" class="demo-form-inline" size="small">
				...
				<el-form-item label="车辆：">
					<el-input v-model="searchForm.vehicle" placeholder="请输入车辆" clearable size="small">
		...
		<el-table :data="tableData" border style="width: 100%" v-loading="loading" size="small">
			...
			<el-table-column prop="debtDetail" label="欠款明细" width="120">
				<template slot-scope="scope">
					<span :class="{ negative: scope.row.debtDetail < 0 }">{{ scope.row.debtDetail }}</span>
				</template>
			</el-table-column>
