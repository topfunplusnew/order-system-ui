	...
	<div class="app-container">
				...
				<el-row>
					...
					<el-col :span="6">
						...
						<el-form-item
							...
							prop="isIncludeTaxSale"
						>
							<el-radio v-model="form.isIncludeTaxSale" :label="1"
								>是</el-radio
							>
							<el-radio v-model="form.isIncludeTaxSale" :label="0"
								>否</el-radio
							>
						</el-form-item>
							...
							<el-row>
								...
								<el-col :span="3">
									<SearchOption
										...
										@commitBack="handleCommitBackSea"
									>
										<template #table-columns>
											<el-table-column
												label="车牌"
		...
		>
			<div slot="footer" class="dialog-footer">
				...
				<el-button @click="secondInvoiceInVisible = false">
					取 消</el-button
				>
			</div>
		</el-dialog>
		...
		>
			<div slot="footer" class="dialog-footer">
				...
				<el-button @click="breakInvoiceInVisible = false"
					>取 消</el-button
				>
			</div>
		</el-dialog>
...
export default {
	...
	created() {
		...
		this.getList();
		if (
			localStorage.getItem('inventory-columns') === 'null' ||
			...
			this.$refs['form'].validate(valid => {
				if (valid) {
					if (this.form.id != null) {
						...
						this.form.isIncludeTaxFactory =
							this.form.isIncludeTaxFactory === '是' ? '1' : '0';
						this.form.isIncludeTaxSale =
							this.form.isIncludeTaxSale === '是' ? '1' : '0';
