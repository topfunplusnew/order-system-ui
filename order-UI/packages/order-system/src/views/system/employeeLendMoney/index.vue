<template>
	<div class="app-container">
			...
			<template #info>
				<el-table v-if="recoverMoneyList.length !== 0" :data="recoverMoneyList" size="mini" :cell-style="() => {
					...
					<el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="240"
						fixed="right">
						<template slot-scope="scope">
							<el-button size="mini" type="primary" @click="handleUpdateRecoverMoney(scope.row)"
								v-hasPermi="['system:recovermoney:edit']">修改</el-button>
							<el-button v-hasPermi="['system:recovermoney:remove']" size="mini" type="danger"
								@click="handleDeleteRecoverMoney(scope.row)">删除</el-button>
						</template>
					</el-table-column>
				</el-table>
		...
		<!--    导出弹窗-->
		<el-dialog :close-on-click-modal="false" :show-close="false" title="请选择导出时间段" :visible.sync="dialogVisible"
			width="30%">
		...
		<!--    修改记录的修改-->
		<el-dialog :close-on-click-modal="false" :show-close="false" :title="recoverMoneyTitle"
			:visible.sync="recoverMoneyOpen" width="500px" append-to-body>
...
export default {
	...
	components: { BankType, ApplyPayment, SearchOption, InfoDialog },
