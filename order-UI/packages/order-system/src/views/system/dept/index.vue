<template>
	<div class="app-container">
		...
		<!-- 添加或修改部门对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" :title="title" :visible.sync="open" width="600px" append-to-body>
