<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			<el-col :span="1.5">
				<el-button
					v-hasPermi="['system:oilcardmain:add']"
					type="primary"
					plain
					icon="el-icon-plus"
					size="mini"
			...
			<el-col :span="1.5">
				<el-button
					v-hasPermi="['system:oilcardmain:edit']"
					type="success"
					plain
					icon="el-icon-edit"
					size="mini"
			...
			<el-col :span="1.5">
				<el-button
					v-hasPermi="['system:oilcardmain:remove']"
					type="danger"
					plain
					icon="el-icon-delete"
					size="mini"
			...
			<el-col :span="1.5">
				<el-button
					v-hasPermi="['system:oilcardmain:export']"
					type="warning"
					plain
		...
		>
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				...
				<el-form-item label="主卡转副卡充值金额" prop="toPlusCardMoney">
					<el-input
						v-model="form.toPlusCardMoney"
						placeholder="请输入主卡转副卡充值金额"
					/>
				</el-form-item>
				<el-form-item label="加油量" prop="refuelingNumber">
					<el-input
						v-model="form.refuelingNumber"
						placeholder="请输入加油量"
					/>
				</el-form-item>
				<el-form-item label="单价" prop="unitPrice">
