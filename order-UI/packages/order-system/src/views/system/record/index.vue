				...
				<el-row v-if="cashType === CASH_TYPE.OFF_SETTING">
					...
					<el-form-item label="收入方">
						<el-row>
							...
							<!--              如果是司机-->
							<el-col
								v-if="form.sourceCompanyType === '司机'"
								:span="4"
							>
								<SearchOption
									:limit-info="{}"
							...
							<!--              如果是己方公司 -->
							<el-col
								v-if="form.sourceCompanyType === '己方公司'"
								:span="4"
							>
								<SearchOption
									:limit-info="{
				...
				<el-row v-if="cashType === CASH_TYPE.OFF_SETTING">
					...
					<el-form-item label="支出方">
						<el-row>
							...
							<!--              如果是司机-->
							<el-col
								v-if="form.targetCompanyType === '司机'"
								:span="4"
							>
								<SearchOption
									:limit-info="{}"
