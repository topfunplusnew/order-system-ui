<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button v-hasPermi="['system:balanceaccounts:add']" type="danger" size="mini"
					@click="handleAdd">新增平账信息</el-button>
			</el-col>
			<right-toolbar :showSearch.sync="showSearch" :columns="columns" @queryTable="getList">
				...
				<template #export>
					<el-col :span="1.5">
						<el-button v-hasPermi="['system:balanceaccounts:export']" plain icon="el-icon-folder-opened"
		...
		<el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="BalanceAccountsList"
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width">
				<template slot-scope="scope">
					<el-button v-hasPermi="['system:balanceaccounts:edit']" size="mini" type="primary"
						@click="handleUpdate(scope.row)">编辑</el-button>
					<el-button v-hasPermi="['system:balanceaccounts:remove']" size="mini" type="danger"
		...
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false"
			...
			<el-form ref="form" :model="form" :rules="rules" label-width="120px">
				<el-form-item label="操作时间" prop="operateDate">
					...
					<el-date-picker v-model="form.operateDate" type="datetime" placeholder="选择操作时间"
				...
				<el-form-item label="对方公司" prop="companyName">
					<el-row>
						...
						<SearchOption :limit-info="{ companyType: value }" :get-data="listCompany" query-info="companyName"
							query-label="公司名称" :query-name="queryCompanyName" @update:queryName="handleUpdateCompanyName"
		...
		<!--    点击公司查询的弹窗-->
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false"
			:show-close="false" title="公司查询" :visible.sync="companyDialogVisible" width="40%">
			<el-row>
