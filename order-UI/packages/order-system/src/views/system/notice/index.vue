<template>
	<div class="app-container">
		...
		<!-- 添加或修改公告对话框 -->
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" :title="title" :visible.sync="open" width="780px" append-to-body>
