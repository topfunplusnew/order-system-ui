		...
		<div class="card">
			<div class="card__img">
				<svg width="100%" xmlns="http://www.w3.org/2000/svg">
					...
					<defs>
						<linearGradient id="a" gradientTransform="rotate(222,648,379)" y2="100%" y1="0" x2="0" x1="0" gradientUnits="userSpaceOnUse">
							<stop stop-color="#ffffff" offset="0"></stop>
							<stop stop-color="#FC726E" offset="1"></stop>
						</linearGradient>
						<pattern id="b" viewBox="0 0 1080 900" y="0" x="0" height="250" width="300" patternUnits="userSpaceOnUse">
							<g fill-opacity="0.5">
			...
			<div class="card__title">{{ userInfo.userName }}</div>
			<div class="card__subtitle">{{ userInfo.phonenumber }}</div>
