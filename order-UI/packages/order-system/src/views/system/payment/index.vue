      ...
      <div class="table-wrapper" id="printBox">
        <table class="native-table">
          ...
          <tr>
            ...
            <!-- 银行卡流水附件 -->
            <th v-if="columns[16] && columns[16].visible" :style="{ width: columnWidths.transactionHistoryAttachment }">银行卡流水附件</th>            <!-- 录入人员 -->
              ...
              <el-tooltip effect="light" placement="top" enterable :hide-after="0" popper-class="interactive-tooltip">
                <div slot="content" @click.stop>
                  <CheckFiles
                      ...
                      @needToUpdate="value => handleUpdateFilePath(value, row, getPayment, updatePayment)"
          ...
          <el-col :span="form.companyType === PAYMENT_TARGET_TYPE.PAYMENT_FEE ? 24 : 12">
            ...
            <el-form-item label="附件" prop="attachmentIds">
              <UploadFilesButton ref="attachmentUpload" flag="attachments"
                                 ...
                                 @files-updated="handleAttachmentFilesUpdated" style="width: 100%"/>
            </el-form-item>
        ...
        <div class="order-freight-body">
          ...
          <div class="order-freight-info">
            <el-collapse v-model="activeNames">
              <el-collapse-item v-for="(item, index) in viewFreightList" :key="index"
                ...
                <el-card class="box-card">
                  <div>
                    <el-descriptions :title="'运费信息(' + (index + 1) + ')'" :column="2" border>
                      ...
                      <el-descriptions-item label="司机/海运公司" :span="1">{{
                          item.driverName || '-'
                        }}
                      </el-descriptions-item>
                      ...
                      <el-descriptions-item label="对方户名" :span="1">{{
                          item.otherAcountsName || '-'
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="对方账号" :span="1">{{
                          item.otherBankNo || '-'
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="对方开户行" :span="1">{{
                          item.otherBankName || '-'
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="申请人员" :span="1">{{
                          item.applyUserName || '-'
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="申请日期" :span="1">{{
                          item.applyDate || '-'
                        }}
                      </el-descriptions-item>
                      <el-descriptions-item label="付款人员" :span="1">{{
                          item.payUserName || '-'
                        }}
                      </el-descriptions-item>
                      ...
                      <el-descriptions-item label="付款信息" :span="2">
                        <div v-if="item.payment" style="margin-top: 8px">
                          <el-descriptions :column="2" border size="mini">
                            <el-descriptions-item label="付款编码" :span="1">{{
                                item.payment.code || '-'
                              }}
                            </el-descriptions-item>
                            <el-descriptions-item label="付款日期" :span="1">{{
                                item.payment.fundsDate || '-'
                              }}
                            </el-descriptions-item>
                            <el-descriptions-item label="付款类型" :span="1">{{
                            ...
                            <el-descriptions-item label="我方银行类型" :span="1">{{
                                item.payment.selfBankCardType || '-'
                              }}
                            </el-descriptions-item>
                            ...
                            <el-descriptions-item label="对方户名" :span="1">{{
                                item.payment.otherAccountsName || '-'
                              }}
                            </el-descriptions-item>
                            <el-descriptions-item label="对方账号" :span="1">{{
                                item.payment.otherBankNo || '-'
                              }}
                            </el-descriptions-item>
                            <el-descriptions-item label="对方开户行" :span="1">{{
                                item.payment.otherBankName || '-'
                              }}
                            </el-descriptions-item>
                            ...
                            <el-descriptions-item label="付款备注" :span="2">{{
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      // 查询
      return listPayment(addDateRange({
        ...this.queryParams,
        payType: payTypeString
      }, this.dateRange, 'payment')).then(response => {
