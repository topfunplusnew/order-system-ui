      ...
      >
						...
						<el-row>
							...
							<el-col :span="3">
								<SearchOption
									...
									@update:queryName="
										handleUpdateQueryNameOtherSupplier
									"
						...
						<el-row>
							...
							<el-col :span="3">
								<SearchOption
									...
									icon="el-icon-search"
									@update:queryName="
										handleUpdateQueryNameOtherCustomer
									"
						...
						<el-row>
							...
							<el-col :span="3">
								<SearchOption
									...
									@update:queryName="
										handleUpdateQueryNameOtherDriver
									"
		...
		>
			...
			<span slot="footer" class="dialog-footer">
				<el-button @click="chooseBankDialogVisible = false"
					>取 消</el-button
				>
		...
		>
				...
				<el-table-column label="对方账户类型">
					<template slot-scope="scope">
						<BankType
							...
							@updateSelectedType="
								value =>
									changeRowOtherBankType(scope.row, value)
							"
						/>
					</template>
				</el-table-column>
			...
			<span slot="footer" class="dialog-footer">
				...
				<el-button type="primary" @click="handleSubmitOnce"
					>确 定</el-button
				>
			</span>
		</el-dialog>
		...
		handleUpdate(row) {
			...
			if (!row.selfBankID) {
				...
				this.$confirm('是否付款?', '提示', {
					...
					// 只需要更新状态
					updatePayment({ ...row, paymentState: '已支付' }).then(
						res => {
