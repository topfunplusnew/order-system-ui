		...
		>
			<el-form ref="form" :model="form" :rules="rules" label-width="80px">
				<el-form-item label="借出款编号" prop="futuresNO">
					<el-input
						v-model="form.futuresNO"
						placeholder="请输入借出款编号"
					/>
				</el-form-item>
				<el-form-item label="还款编号" prop="recoverNO">
					<el-input
						v-model="form.recoverNO"
						placeholder="请输入还款编号"
					/>
				</el-form-item>
...
export default {
	...
	created() {
		this.getList();
		if (
			localStorage.getItem('recovermoney-columns') === 'null' ||
			!localStorage.getItem('recovermoney-columns')
		) {
			// 设置localStorage
			localStorage.setItem(
				'recovermoney-columns',
