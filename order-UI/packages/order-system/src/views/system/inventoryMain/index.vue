  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="陆运司机电话" prop="landDriverTel">
        <el-input v-model="queryParams.landDriverTel" class="input-standard" placeholder="请输入陆运司机电话" clearable
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="陆地司机姓名" prop="landDriverName">
        <el-input v-model="queryParams.landDriverName" class="input-standard" placeholder="请输入陆地司机姓名" clearable
                  @keyup.enter.native="handleQuery"/>
      </el-form-item>
          ...
          <el-row :gutter="10">
            ...
            <el-col :span="1.5">
              <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                         v-hasPermi="['system:inventoryMain:export']">导出
              </el-button>
            </el-col>
          </el-row>
        </template>
    ...
    <div style="height: 800px">
      <DragDiv :initial-left-width="300" :min-left-width="200" :min-right-width="400" :divider-width="6"
          ...
          <div style="height: 100%; display: flex; flex-direction: column">
            ...
            >
              ...
              <CustomTableColumn v-if="columns[18].visible" label="录入人员" align="center" prop="userName"
                                 width="120"/>
              <CustomTableColumn v-if="columns[19].visible" label="收到条附件" align="center" prop="attachmentList"
    ...
    <el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :title="title" :visible.sync="open"
               width="1600px" append-to-body :close-on-click-modal="false">
        ...
        >
          ...
          <CustomTableColumn label="行操作" align="center" width="100">
            <template slot-scope="scope">
              ...
              <el-button v-else size="mini" type="success" icon="el-icon-check" @click="handleRowSave(scope.row)">保存
              </el-button>
            </template>
          </CustomTableColumn>
