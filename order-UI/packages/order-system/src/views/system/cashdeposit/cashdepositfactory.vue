...
<template>
	<div class="app-container">
		...
		<!-- 添加或修改向外部借出款信息对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="添加厂家保证金" :visible.sync="open" width="50%" append-to-body>
				...
				<el-row>
					<el-col :span="12">
						...
						<el-form-item label="支付厂家保证金时间" prop="futuresDate">
							<el-date-picker v-model="form.futuresDate" type="datetime" placeholder="请选择支付厂家保证金时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
						</el-form-item>
		...
		<!--    坏账损失-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="坏账损失" :visible.sync="applyDialogVisible" width="45%">
			<keep-alive>
				<ApplyPayment
					:extra-information="{
