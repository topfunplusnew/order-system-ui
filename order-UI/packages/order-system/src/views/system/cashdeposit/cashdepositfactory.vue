...
<template>
	<div class="app-container">
		...
		<el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="lendMoneyList"
			...
			<!-- 我方支付账户 -->
			<el-table-column v-if="columns[7].visible" label="我方支付账户" align="center" prop="selfAcountsName" width="160"
				show-overflow-tooltip />
			...
			<!-- 支付厂家保证金时间 -->
			<el-table-column v-if="columns[10].visible" label="支付厂家保证金时间" align="center" prop="futuresDate" width="110"
				show-overflow-tooltip />
		...
		<!-- 添加或修改向外部借出款信息对话框 -->
		<el-dialog :close-on-click-modal="false" :show-close="false" title="添加厂家保证金" :visible.sync="open" width="50%"
			append-to-body>
