	...
	<div class="app-container">
		...
		<template>
			...
			>
				...
				<!-- 公司名称 -->
				<el-table-column v-if="columns[1].visible" label="公司名称" align="center" prop="target" width="110" show-overflow-tooltip />

				<!-- 对方类型 -->
				<el-table-column v-if="columns[2].visible" label="对方类型" align="center" prop="targetType" width="110" show-overflow-tooltip />
				...
				<!-- 支付期货保证金时间 -->
				<el-table-column v-if="columns[10].visible" label="支付期货保证金时间" align="center" prop="futuresDate" width="130" show-overflow-tooltip />
		...
		<!-- 添加或修改向外部借出款信息对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="添加期货保证金" :visible.sync="open" width="50%" append-to-body>
				...
				<el-row>
					<el-col :span="12">
						...
						<el-form-item label="支付期货保证金时间" prop="futuresDate">
							<el-date-picker v-model="form.futuresDate" type="datetime" placeholder="请选择支付期货保证金时间" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
						</el-form-item>
		...
		<!--    回收弹窗-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="收回资金操作" :visible.sync="giveRecoverMoneyShow" width="40%" append-to-body>
			<el-row>
		...
		<!--    付款申请-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="付款申请" :visible.sync="applyDialogVisible" width="45%">
			<keep-alive>
				<ApplyPayment
					:extra-information="{
