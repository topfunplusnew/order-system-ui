  ...
  <div class="app-container">
    ...
    <template>
      <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="lendMoneyList" size="mini"
        :cell-style="() => ({ padding: '1px' })" @selection-change="handleSelectionChange">
        <!-- 期货保证金公司 -->
        ...
        <!-- 公司名称 -->
        <el-table-column v-if="columns[1].visible" label="公司名称" align="center" prop="target" show-overflow-tooltip />
  
        <!-- 对方类型 -->
        <el-table-column v-if="columns[2].visible" label="对方类型" align="center" prop="targetType" show-overflow-tooltip />
              ...
              <el-row>
                ...
                <el-col :span="3">
                  <SearchOption :get-data="listBankAccount" icon="el-icon-search" :limit-info="{
                    ...
                    @commitBack="handleCommitBackSelf" @update:queryName="handleUpdateQueryName">
                    <template #table-columns>
