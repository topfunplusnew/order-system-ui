...
<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button size="mini" type="danger" @click="handleAdd">添加期货保证金</el-button>
			</el-col>
		...
		<template>
			<el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="lendMoneyList"
				size="mini" :cell-style="() => ({ padding: '1px' })" @selection-change="handleSelectionChange">
				<!-- 期货保证金公司 -->
				...
				<!-- 公司名称 -->
				<el-table-column v-if="columns[1].visible" label="公司名称" align="center" prop="target"
					show-overflow-tooltip />

				<!-- 对方类型 -->
				<el-table-column v-if="columns[2].visible" label="对方类型" align="center" prop="targetType"
					show-overflow-tooltip />
				...
				<!-- 事由 -->
				<el-table-column v-if="columns[11].visible" label="事由" align="center" prop="reason"
					show-overflow-tooltip />
		...
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false"
			:show-close="false" title="添加期货保证金" :visible.sync="open" width="50%" append-to-body>
				...
				<el-row>
					<el-col :span="12">
						...
						<el-form-item label="支付期货保证金时间" prop="futuresDate">
							<el-date-picker v-model="form.futuresDate" type="datetime" placeholder="请选择支付期货保证金时间"
								value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
						</el-form-item>
