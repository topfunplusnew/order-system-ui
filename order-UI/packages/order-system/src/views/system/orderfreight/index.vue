<template>
	<div class="app-container">
		...
		>
			...
			>
				<template slot-scope="scope">
					<el-tag
						v-if="scope.row.source === FREIGHT_TYPE.GOODS_ORDER"
					>
						订单
					</el-tag>
		...
		<!--    一键付运费的弹窗-->
		<InfoDialog
			:visible="freightOnceVisible"
			title="一键付运费"
			@close="freightOnceVisible = false"
		>
			<template #info>
				<!--        输入己方信息-->
					...
					<div class="order-freight-self-info">
						...
						>
							...
							>
								<el-row>
									<el-col :span="10">
										<el-input
											v-model="
												freightSelfOnceInfo.selfAcountsName
											"
											placeholder="请输入己方户名"
										/>
									</el-col>
							...
							<el-form-item label="己方账号" prop="selfBankNo">
								<el-input
									v-model="freightSelfOnceInfo.selfBankNo"
									placeholder="请输入己方账号"
								/>
							</el-form-item>
							<el-form-item
							...
							>
								<el-input
									v-model="freightSelfOnceInfo.selfBankName"
...
export default {
	...
	created() {
		...
		// 设置本地存储
		if (
			localStorage.getItem('freight-columns') === 'null' ||
