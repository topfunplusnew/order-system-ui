	...
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<right-toolbar :show-search.sync="showSearch" :columns="columns" @queryTable="getList">
				...
				<template #export>
					<el-col :span="1.5">
						<el-button v-hasPermi="['system:freight:export']" plain icon="el-icon-folder-opened" size="mini" @click="handleExport" />
					</el-col>
				</template>
			</right-toolbar>
		</el-row>
		...
		>
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="150">
				<template slot-scope="scope">
					...
					<el-button v-if="scope.row.isedit" v-hasPermi="['system:freight:edit']" size="mini" type="primary" @click="handleUpdate(scope.row)">修改</el-button>
					<el-button v-hasPermi="['system:freight:remove']" size="mini" type="danger" @click="handleDelete(scope.row)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<el-dialog :close-on-click-modal="false" :show-close="false" title="运费付款申请" :visible.sync="applyPaymentVisible" width="500px" append-to-body>
			<keep-alive>
