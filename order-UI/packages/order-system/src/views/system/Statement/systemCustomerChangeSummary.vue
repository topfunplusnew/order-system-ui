<template>
	<div class="app-container">
		...
		>
			...
			<el-table-column v-if="columns[2].visible" show-overflow-tooltip label="客户名称" align="center" prop="companyName" />
			<el-table-column v-if="columns[3].visible" show-overflow-tooltip label="昨日欠款金额" align="center" prop="previousDayCarryover" />
			<el-table-column v-if="columns[4].visible" show-overflow-tooltip label="当日销货金额" align="center" prop="dailyOrderPayments" />
			<el-table-column v-if="columns[5].visible" show-overflow-tooltip label="当日销售票点金额" align="center" prop="dailyInvoiceAmount" />
			<el-table-column v-if="columns[6].visible" show-overflow-tooltip label="当日回款金额" align="center" prop="dailyReceiveMoney" />
		...
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="请选择导出时间" :visible.sync="dialogVisible" width="30%">
	...
	data() {
		return {
			...
			columns: [
				...
				{ key: 4, label: '当日销货金额', visible: true },
				{ key: 5, label: '当日销售票点金额', visible: true },
				{ key: 6, label: '当日回款金额', visible: true },
