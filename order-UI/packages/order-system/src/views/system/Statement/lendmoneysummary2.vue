...
<template>
	<div class="app-container">
		...
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="请选择" :visible.sync="dialogVisible" width="500px">
