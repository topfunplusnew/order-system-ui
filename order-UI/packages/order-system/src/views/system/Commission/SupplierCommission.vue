	...
	<div class="app-container">
		...
		<el-table ref="multipleTable" id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border
			...
			<el-table-column v-if="columns[8].visible" show-overflow-tooltip label="包数" align="center" prop="packs"
				width="100" />
			<el-table-column v-if="columns[9].visible" show-overflow-tooltip label="出厂片数" align="center" prop="pieces"
				width="100" />
			...
			<el-table-column v-if="columns[22].visible" show-overflow-tooltip label="实际厂家佣金" align="center"
