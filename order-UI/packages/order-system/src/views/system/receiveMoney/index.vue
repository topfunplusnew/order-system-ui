	...
	<div class="app-container">
		<el-form v-show="showSearch" ref="queryForm" :model="queryParams" size="mini" :inline="true"
			...
			<el-form-item label="开始日期" prop="fundsDate">
				<el-date-picker v-model="queryParams.startTime" type="datetime" placeholder="请选择日期"
					value-format="yyyy-MM-dd HH:mm:ss" class="w-85px" />
			</el-form-item>
			<el-form-item label="结束日期" prop="fundsDate">
				<el-date-picker v-model="queryParams.endTime" type="datetime" placeholder="请选择日期"
					value-format="yyyy-MM-dd HH:mm:ss" class="w-85px" />
			</el-form-item>
			<el-form-item label="我方户名" prop="selfAcountsName">
				<el-input v-model="queryParams.selfAcountsName" placeholder="请输入我方户名" clearable class="w-85px"
					@keyup.enter.native="handleQuery" />
			</el-form-item>

			<el-form-item label="对方户名" prop="otherAcountsName">
				<el-input v-model="queryParams.otherAcountsName" placeholder="请输入对方户名" clearable class="w-85px"
					@keyup.enter.native="handleQuery" />
			</el-form-item>
			<el-form-item>
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button v-hasPermi="['system:receivemoney:add']" type="danger" size="mini"
					@click="handleAdd">新增收款信息</el-button>
			</el-col>
			<right-toolbar :show-search.sync="showSearch" :columns="columns" @queryTable="getList">
				...
				<template #export>
					<el-col :span="1.5">
						<el-button v-hasPermi="['system:receivemoney:export']" plain icon="el-icon-folder-opened"
		...
		<el-table id="printBox" v-horizontal-scroll="'always'" v-loading="loading" border :data="receiveMoneyList"
			...
			<el-table-column v-if="columns[1].visible" label="支付类型" align="center" prop="receiveType" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[2].visible" label="金额" align="center" prop="moneyAmount" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[3].visible" label="我方户名" align="center" prop="selfAcountsName" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[4].visible" label="我方账号" align="center" prop="selfBankNo" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[5].visible" label="我方开户行" align="center" prop="selfBankName" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[6].visible" label="对方户名" align="center" prop="otherAcountsName" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[7].visible" label="对方账号" align="center" prop="otherBankNo" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[8].visible" label="对方开户行" align="center" prop="otherBankName" width="165"
				show-overflow-tooltip />
			<el-table-column v-if="columns[9].visible" label="对方公司" align="center" prop="companyName" width="165"
				show-overflow-tooltip />
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right" width="150">
				<template slot-scope="scope">
					<el-button v-hasPermi="['system:receivemoney:edit']" size="mini" type="primary"
						@click="handleUpdate(scope.row)">修改</el-button>
					<el-button v-hasPermi="['system:receivemoney:remove']" size="mini" type="danger"
		...
		<!-- 添加或修改收款信息对话框 -->
		<el-dialog :close-on-click-modal="false" :show-close="false" :title="title" :visible.sync="open" width="1200px"
			append-to-body>
			<div style="height: 530px">
				<el-form ref="form" :model="form" :rules="rules" label-width="150px">
					...
					<el-col :span="12">
						...
						<el-form-item label="我方银行账户类型">
							<BankType :bill-type="BankAcceptanceType.PAY_TYPE.RECEIVE"
								:select-type="form.selfBankCardType" @updateSelectedType="changeSelfBankType"
					...
					<!--        第二列-->
					<el-col :span="12">
						<el-form-item v-if="value !== '对外付款'" :label="value === '司机' ? '司机' : '对方公司'"
							prop="companyName">
							<el-row>
								<el-col :span="14">
								...
								<el-col v-if="value === '司机'" :span="4">
									<SearchOption :limit-info="{}" :get-data="listCars" query-info="carNo"
										query-label="车牌/柜号" :query-name="carName"
										@update:queryName="handleUpdateCarName" @commitBack="handleCommitBackCar">
										<template #table-columns>
						...
						<el-form-item label="对方银行账户类型" v-if="value !== '对外付款'">
							<BankType :option-baned="true" :baned="true" :select-type="form.otherBankCardType"
