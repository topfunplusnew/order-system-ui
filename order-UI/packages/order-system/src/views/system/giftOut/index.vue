	...
	<div class="app-container">
		<el-form id="top-search-form-item" v-show="showSearch" ref="queryForm" :model="queryParams" size="mini" :inline="true" label-width="120px">
			...
			<el-form-item label="礼品来源" prop="giftSource">
				<el-row :gutter="10">
					<el-col :span="20">
						<el-select v-model="queryParams.giftSource" placeholder="请选择礼品来源" clearable @keyup.enter.native="handleQuery" style="width: 100%">
		...
		>
			...
			<el-table-column v-if="columns[2].visible" label="礼品来源" align="center" prop="giftSource" width="100" show-overflow-tooltip>
				<template #default="scope">
				...
				<el-row :gutter="20">
					...
					<el-col :span="12">
						<el-form-item label="礼品来源" prop="giftSource">
							<el-row :gutter="10">
								<el-col :span="20">
									<el-select v-model="form.giftSource" placeholder="请选择礼品来源" style="width: 100%">
...
export default {
	...
	data() {
		return {
			...
			rules: {
				...
				giftSource: [{ required: true, message: '请选择礼品来源', trigger: 'blur' }],
	...
	methods: {
		...
		handleCommitBackGiftSource(row) {
			if (row) {
				this.form.giftSource = row.id;
				this.giftSourceName = row.itemName;
				this.queryParams.giftSource = row.id;
			}
		}
	}
};
