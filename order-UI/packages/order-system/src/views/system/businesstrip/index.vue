<template>
	<div class="app-container">
		...
		<!-- 添加或修改出差对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" :title="title" :visible.sync="open" width="1000px">
		...
		<!--    付款申请弹窗-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="提示" :visible.sync="applyForPaymentDialogVisible" width="60%">
			<keep-alive>
		...
		<!-- 修改未审核通过车辆列表弹窗 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :visible.sync="notPassedCarDialogVisible" title="未审核通过的车辆" width="80%" height="600px">
