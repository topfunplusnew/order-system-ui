<template>
	<div class="app-container">
		...
		<!-- 添加或修改从外部借款信息对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" :title="title" :visible.sync="open" width="60%" append-to-body>
		...
		<!--    点击还款的弹框-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="还款操作" :visible.sync="giveBackMoneyShow" width="500px">
			<el-row>
