		...
		>
			...
			>
				<template #default="scope">
					{{
						scope.row.supplierPointAmount
							| changeNumber(changeLength)
					}}
				</template>
			</el-table-column>
			<el-table-column
			...
			<el-row>
				...
				>
					...
					<el-col :span="12">
						...
						>
							<el-input
								v-model="form.customerTicketPoint"
								placeholder="请输入客户票点"
							/>
						</el-form-item>
						<el-form-item
						...
						>
							<el-input
								v-model="form.customerPointAmount"
								placeholder="请输入票点金额"
							/>
						</el-form-item>
						<el-form-item label="开票日期" prop="invoiceDate">
						...
						<el-form-item label="客户公司名称" prop="customer">
							...
							<el-col :span="4">
								<SearchOption
									...
									@update:queryName="
										handleUpdateCompanyCustomerName
									"
									@commitBack="
										handleCommitBackCompanyCustomer
									"
								>
									<template #table-columns>
										<el-table-column
...
export default {
	...
	created() {
		this.getList();
		if (
			localStorage.getItem('invoiceother-columns') === 'null' ||
