<template>
	<div class="app-container">
		<el-form v-show="showSearch" ref="queryForm" :model="queryParams" size="mini" :inline="true" label-width="150px">
			<el-form-item label="开票日期" prop="invoiceDate">
				<el-date-picker v-model="dateRange" type="daterange" start-placeholder="开始日期" end-placeholder="结束日期"
					range-separator="至" value-format="yyyy-MM-dd" unlink-panels style="width: 240px" />
			</el-form-item>
			<el-form-item label="开票单位" prop="invoiceCompanyName">
				<el-input v-model="queryParams.invoiceCompanyName" placeholder="请输入开票单位" clearable
					@keyup.enter.native="handleQuery" />
			</el-form-item>
			<el-form-item label="对方名称" prop="mixCompanyName">
				<el-input v-model="queryParams.params.mixCompanyName" placeholder="可搜索供应商或客户名称" clearable
					@keyup.enter.native="handleQuery" />
			</el-form-item>
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button v-hasPermi="['system:invoiceother:add']" type="danger" size="mini"
			...
			<right-toolbar :showSearch.sync="showSearch" :columns="columns" @queryTable="getList">
				...
				<template #export>
					<el-col :span="1.5">
						<el-button v-hasPermi="['system:invoiceother:export']" plain icon="el-icon-folder-opened"
		...
		<el-table v-horizontal-scroll="'always'" v-loading="loading" border :data="invoiceOtherList" size="mini"
			:cell-style="
							() => {
								return { padding: '.5px' };
							}
			...
			<el-table-column v-if="columns[4].visible" label="供应商公司名称" align="center" prop="Supplier"
				show-overflow-tooltip />
			<el-table-column v-if="columns[0].visible" label="日期" align="center" prop="invoiceDate" show-overflow-tooltip />
			<el-table-column v-if="columns[1].visible" label="开票金额" align="center" prop="invoiceAmount"
				show-overflow-tooltip />
			<el-table-column v-if="columns[2].visible" label="供应商票点" align="center" prop="supplierTicketPoint"
				show-overflow-tooltip />
			<el-table-column v-if="columns[3].visible" label="供应商票点金额" align="center" prop="supplierPointAmount"
				show-overflow-tooltip>
			...
			<el-table-column v-if="columns[12].visible" label="开票单位" align="center" prop="invoiceCompanyName"
				show-overflow-tooltip />
			...
			<el-table-column v-if="columns[6].visible" label="订单信息" align="center" prop="isOrderTax" width="180"
				show-overflow-tooltip>
				<template slot-scope="scope">
					<el-row>
						<el-button size="mini" type="text" @click="checkOrderInfo(scope.row)"
							:disabled="!scope.row.ordersNo">查看订单信息</el-button>
					</el-row>
				</template>
			</el-table-column>
				...
				<template slot-scope="scope">
					...
					<el-dropdown @command="command => handleCommand(command, scope.row)">
						...
						<el-dropdown-menu slot="dropdown">
							...
							<el-dropdown-item v-hasPermi="['system:invoiceother:remove']" command="delete"
		...
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false"
			:show-close="false" :title="title" :visible.sync="open" append-to-body width="800px">
			<el-row>
				<el-form ref="form" :model="form" :rules="rules" label-width="140px">
					...
					<el-col :span="12">
						<el-form-item label="订单ID" prop="ordersNo">
							...
							<el-col :span="4">
								<SearchOption :limit-info="{}" :get-data="listGoodsOrder" query-info="customer"
									...
									<template #table-columns>
										...
										<el-table-column show-overflow-tooltip label="开票状态" align="center"
											prop="invoiceState" width="120px"></el-table-column>
						...
						<el-form-item label="客户名称" prop="customer">
							...
							<el-col :span="4">
								<SearchOption :limit-info="{ companyType: '客户' }" :get-data="listCompany"
									query-info="companyName" query-label="公司名称" :query-name="queryCompanyCustomerName"
