		...
		<div style="margin: 19px 19px">
			...
			>
				...
				<template #info>
					...
					<OrderList
						...
						@update:selectedGoodsOrderList="
							handleEmitGoodsOrderList
						"
					>
						<template #option>
					...
					<!--        如果是发票买入  -->
					<InvoiceList
						v-if="DOC_TYPE === DocumentNumber.INVOICE_IN"
						:invoice-type="TableName.INVOICE_IN"
						@update:selectedGoodsOrderList="
							handleEmitGoodsOrderList
						"
					>
					...
					<!--        如果是发票卖出 那么就传递卖出列表-->
					<InvoiceList
						v-if="DOC_TYPE === DocumentNumber.INVOICE_OUT"
						:invoice-type="TableName.INVOICE_OUT"
						@update:selectedGoodsOrderList="
							handleEmitGoodsOrderList
						"
					>
					...
					<!--        第三方-->
					<InvoiceList
						v-if="DOC_TYPE === DocumentNumber.INVOICE_OTHER"
						:invoice-type="TableName.INVOICE_OTHER"
						@update:selectedGoodsOrderList="
							handleEmitGoodsOrderList
						"
					>
					...
					<!--          如果是库存列表-->
					<InventoryList
						v-if="DOC_TYPE === DocumentNumber.INVENTORY"
						@update:selectedGoodsOrderList="
							handleEmitGoodsOrderList
						"
					>
			...
			>
				<template #info>
					...
					<el-row
						v-if="
							DOC_TYPE === DocumentNumber.INVOICE_IN ||
							DOC_TYPE === DocumentNumber.INVOICE_OUT
						"
					>
						<el-table
							id="printBox"
					...
					<div style="text-align: center">
						<el-button type="primary" @click="submitMakeCredentials"
							>确定生成</el-button
						>
					</div>
				</template>
