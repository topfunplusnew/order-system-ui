<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<el-col :span="1.5">
				<el-button v-hasPermi="['system:bankacceptance:add']" type="danger" size="mini"
					@click="handleAdd">添加支出商业票据</el-button>
			</el-col>
		...
		<el-table v-loading="loading" v-horizontal-scroll="'always'" id="printBox" border :data="bankAcceptanceList"
			size="mini" show-summary :summary-method="getSummaries" height="480px"
			...
			<el-table-column v-if="columns[1].visible" label="操作日期" align="center" prop="operateDate"
				show-overflow-tooltip />
			<el-table-column v-if="columns[2].visible" label="票据种类" align="center" prop="billCategory"
				show-overflow-tooltip />
			...
			<el-table-column v-if="columns[4].visible" label="收票事由" align="center" prop="reason"
				show-overflow-tooltip />
			<el-table-column v-if="columns[5].visible" label="背书人" align="center" prop="endorserName"
				show-overflow-tooltip />

			<el-table-column v-if="columns[6].visible" label="出票日期" align="center" prop="issueDate"
				show-overflow-tooltip />
			<el-table-column v-if="columns[7].visible" label="到期日期" align="center" prop="dueDate"
				show-overflow-tooltip />
			<el-table-column v-if="columns[8].visible" label="我方承兑账户" align="center" prop="billAccount"
				show-overflow-tooltip />
			<el-table-column v-if="columns[9].visible" label="票据交易日期" align="center" prop="billDate"
				show-overflow-tooltip />

			<el-table-column v-if="columns[10].visible" label="票据金额" align="center" prop="billAmount"
				show-overflow-tooltip />
			<el-table-column v-if="columns[11].visible" label="贴息点数" align="center" prop="inDiscountPoints"
				show-overflow-tooltip />
			<el-table-column v-if="columns[12].visible" label="贴息金额" align="center" prop="inDiscountAmount"
				show-overflow-tooltip />

			<el-table-column v-if="columns[13].visible" label="来源" align="center" prop="origin" show-overflow-tooltip />
			<el-table-column v-if="columns[14].visible" label="备注" align="center" prop="comments"
				show-overflow-tooltip />
					...
					<el-col :span="12">
						...
						<div style="width: 100%">
							<el-form-item label="票据交易日期" prop="billDate">
								<el-date-picker style="width: 100%" v-model="form.billDate" type="datetime"
									placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
							</el-form-item>
						</div>
						<div style="width: 100%">
							<el-form-item label="出票日期" prop="issueDate">
								<el-date-picker style="width: 100%" v-model="form.issueDate" type="datetime"
									placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
							</el-form-item>
						</div>
						<div style="width: 100%">
							<el-form-item label="到期日期" prop="dueDate">
								<el-date-picker style="width: 100%" v-model="form.dueDate" type="datetime"
									placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
							</el-form-item>
						</div>
