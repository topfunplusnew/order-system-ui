  ...
  <div class="app-container">
    ...
    <el-form v-show="showSearch" ref="queryForm" :model="queryParams" size="mini" :inline="true" label-width="68px">
      ...
      <el-form-item label="开户名称" prop="acountsName">
        <el-input v-model="queryParams.acountsName" placeholder="请输入开户名称" clearable
                  @keyup.enter.native="applyFrontendFilter" @input="applyFrontendFilter"/>
      </el-form-item>
      ...
      <el-form-item label="己方公司" prop="displayName">
        <el-input v-model="queryParams.displayName" placeholder="请输入己方公司" clearable
                  @keyup.enter.native="applyFrontendFilter" @input="applyFrontendFilter"/>
      </el-form-item>
      <el-form-item>
    ...
    <el-table
        ...
        :cell-style="
			...
			"
    >
      <el-table-column v-if="columns[1].visible" label="己方公司" align="center" prop="displayName"
