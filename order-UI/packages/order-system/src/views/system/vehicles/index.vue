<template>
	<div class="app-container">
		...
		<!-- 查看附件对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :title="'查看附件'" :visible.sync="attachmentsDialogVisible" width="600px" append-to-body>
			<h3>图片附件</h3>
		...
		<!-- 附件上传对话框 -->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :title="'附件上传'" :visible.sync="uploadDialogVisible" width="600px" append-to-body>
			<el-upload
				class="upload-demo"
