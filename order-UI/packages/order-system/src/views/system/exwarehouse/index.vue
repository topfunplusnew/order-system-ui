<template>
	<div class="app-container">
		...
		<!--    查看订单详情信息-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="查看订单信息" :visible.sync="checkOrderVisible" width="900px">
		...
		<!--    库存信息-->
		<el-dialog v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" :show-close="false" title="查看库存信息" :visible.sync="checkInventoryVisible" width="900px">
