	...
	<div class="app-container">
		<el-form v-show="showSearch" ref="queryForm" :model="timesQuery" size="mini" :inline="true" label-width="68px">
			<el-form-item label="开始时间" prop="beginTime">
				<el-date-picker v-model="timesQuery.beginTime" type="datetime" placeholder="请选择开始时间"
					value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
			</el-form-item>
			<el-form-item label="结束时间" prop="endTime">
				<el-date-picker v-model="timesQuery.endTime" type="datetime" placeholder="请选择结束时间"
					value-format="yyyy-MM-dd HH:mm:ss"></el-date-picker>
			</el-form-item>
		...
		<el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="lendMoneyList" size="mini"
			...
			<el-table-column v-if="columns[4].visible" label="对方账户" align="center" prop="targetAcountsName" width="110"
				show-overflow-tooltip>
				<template #default="scope">
			...
			<el-table-column v-if="columns[6].visible" label="对方开户行" align="center" prop="targetBankName" width="110"
				show-overflow-tooltip>
				<template #default="scope">
			...
			<el-row>
				<el-form :model="recoverMoneyEntity" label-width="120" :rules="receiveRules">
					...
					<el-form-item label="我方银行账户类型">
						<!-- TODO -->
						<BankType :bill-type="BankAcceptanceType.PAY_TYPE.RECEIVE"
							:select-type="recoverMoneyEntity.selfBankCardType" @updateSelectedType="
									value => {
		...
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false"
			...
			<keep-alive>
				<ApplyPayment :table-name="TableName.LEND_MONEY" :t-i-d="tid" :need-money="needMoney" :need-info="needInfo"
