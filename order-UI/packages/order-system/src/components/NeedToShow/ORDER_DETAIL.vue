	...
	<div>
		<el-card>
			<el-descriptions title="订单详情" column="3">
				...
				<el-descriptions-item label="工厂含税">{{ needToShowInfo.isIncludeTaxFactory ? '是' : '否' }}</el-descriptions-item>
				...
				<el-descriptions-item label="销售含税">{{ needToShowInfo.isIncludeTaxSale ? '是' : '否' }}</el-descriptions-item>
				...
				<el-descriptions-item label="吨数">{{ needToShowInfo.tonnage }}</el-descriptions-item>
