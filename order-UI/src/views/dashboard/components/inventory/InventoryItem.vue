...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      paymentFactory00() {
        return fix(
          ((this.orderItemInfo.length * this.orderItemInfo.width * this.orderItemInfo.pieces) /
            1000000) *
      ...
      payments00() {
        return fix(
          ((this.orderItemInfo.length * this.orderItemInfo.width * this.orderItemInfo.outPieces) /
            1000000) *
      ...
      landFreight00() {
        return fix(
          Number(this.orderItemInfo.tonnage) * Number(this.orderItemInfo.landFreightPrice) +
      ...
      landFreight01() {
        return fix(
          Number(this.orderItemInfo.tonnage * this.orderItemInfo.landFreightPrice) +
            Number(this.orderItemInfo.additionalFees)
        )
      },
      profit01() {
        ...
        handler() {
          ...
          if (this.seaFreight === undefined) {
            ...
            this.orderItemInfo.freight =
              Number(this.orderItemInfo.landFreight) + Number(this.orderItemInfo.seaFreight)
          }
        },
        deep: true,
        immediate: true
