...
<script>
  ...
  export default {
    ...
    computed: {
      computedValue() {
        return this.orderItemInfo.supplier === undefined || this.orderItemInfo.supplier === null
          ? this.orderItemInfo.storeName
          : this.orderItemInfo.supplier
      }
    },
    watch: {
      tempOrderInfo: {
    ...
    <el-card class="box-card">
      ...
      <div class="order font-size-12">
        ...
        <div class="order-item">
          ...
          <hr />
          <el-input v-model="orderItemInfo.actualPieces" type="text" placeholder="请输入出厂片数" />
        </div>
        <div class="order-item">
        ...
        <div class="order-item">
          ...
          <hr />
          <el-input v-model="orderItemInfo.customerCommission" type="text" placeholder="客户佣金" />
        </div>
      </div>
      <el-row>
