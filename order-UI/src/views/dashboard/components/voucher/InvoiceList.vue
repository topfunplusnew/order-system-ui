  ...
  <div>
    ...
    <el-row v-if="invoiceType === TableName.INVOICE_OTHER">
      <el-table
        ...
        border :data="invoiceList"
        fit size="mini" :cell-style="()=>{return {padding:'.5px'}}"
    ...
    <el-row v-else>
      <el-table id="printBox" v-horizontal-scroll="'always'" border :data="invoiceList"
                fit size="mini" :cell-style="()=>{return {padding:'.5px'}}" @selection-change="handleSelectionChange">
        <el-table-column type="selection" width="55" fixed="left"></el-table-column>
        <el-table-column label="开票日期" align="center" prop="invoiceDate" show-overflow-tooltip />
        <el-table-column label="我方开票实体" align="center" prop="invoiceObject" width="100px"
                         show-overflow-tooltip />
        <el-table-column label="开票金额" align="center" prop="invoiceAmount" show-overflow-tooltip />
        <el-table-column label="对方公司类别" align="center" prop="companyType" width="100px"
                         show-overflow-tooltip />
        <el-table-column label="对方公司名称" align="center" prop="companyName" width="100px"
                         show-overflow-tooltip />
        <el-table-column label="票据单位名称" align="center" prop="invoiceCompanyName" width="100px"
                         show-overflow-tooltip />
