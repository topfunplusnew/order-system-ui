...
<template>
  <div>
    <!--    搜索组-->
    <QuerySearchBar :handle-query="handleQuery" :options="Options()" :options-invoice="OptionInvent()"
                    :query-params="queryParams" :show-search="true" />
    <!--    这里可以添加一些操作-->
    <slot name="option"></slot>
    <!--    订单列表-->
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" fit border
              :data="goodsOrderList" max-height="750"
