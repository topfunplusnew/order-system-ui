<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-horizontal-scroll="'always'" v-loading="loading" border
              :data="fixedAssetsList" size="mini" :cell-style="()=>{return {padding:'.5px'}}"
              @selection-change="handleSelectionChange">
      <el-table-column v-if="columns[0].visible" label="购入日期" align="center" prop="buyDate" width="120px"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[1].visible" label="资产编号" align="center" prop="assetNo" show-overflow-tooltip />
      <el-table-column v-if="columns[2].visible" label="资产名称" align="center" prop="assetName"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[3].visible" label="规格型号" align="center" prop="specification"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[4].visible" label="数量" align="center" prop="number" show-overflow-tooltip />
      <el-table-column v-if="columns[5].visible" label="计量单位" align="center" prop="measurementUnit"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[6].visible" label="含税金额" align="center" prop="amountIncludeTax"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[7].visible" label="不含税金额" align="center" prop="amountNoTax"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[8].visible" label="户名名称" align="center" prop="account" show-overflow-tooltip />
      <el-table-column v-if="columns[9].visible" label="使用部门" align="center" prop="department"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[10].visible" label="固定资产清理时间" align="center" prop="scrapDate"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[11].visible" label="清理/变卖价值" align="center" prop="saleAmount"
                       show-overflow-tooltip />
