<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border
              :data="bankAccountList" height="450px" size="mini" :cell-style="()=>{return {padding:'.5px'}}"
      ...
      <el-table-column v-if="columns[0].visible" label="账户类型" align="center" prop="acountsType" width="200" />
      ...
      <el-table-column v-if="columns[4].visible" label="公司名称" align="center" prop="companyName" width="200" />
      <el-table-column v-if="columns[1].visible" label="开户名称" align="center" prop="acountsName" width="200" />
      <el-table-column v-if="columns[2].visible" label="银行账号" align="center" prop="bankNo" width="200" />
      <el-table-column v-if="columns[3].visible" label="开户行" align="center" prop="bankName" width="200" />
      <el-table-column v-if="columns[5].visible" label="余额" align="center" prop="amount" width="200" />
