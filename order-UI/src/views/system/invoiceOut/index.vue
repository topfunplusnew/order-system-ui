<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-horizontal-scroll="'always'" v-loading="loading" border
              :data="invoiceOutList" size="mini" :cell-style="()=>{return {padding:'.5px'}}" @selection-change="handleSelectionChange"
              @header-dragend="changeColWidth">
      <el-table-column v-if="columns[0].visible" label="开票日期" align="center" prop="invoiceDate"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[1].visible" label="我方开票实体" align="center" prop="invoiceObject"
                       show-overflow-tooltip />
