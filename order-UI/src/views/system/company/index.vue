		...
		>
			<el-form :model="queryParams">
				<el-row :gutter="4">
					...
					<el-col :span="3">
						<el-button type="primary" @click="handleSearchCompanyGive">
							搜索
						</el-button>
					</el-col>
				</el-row>
			...
			>
					...
					<el-row :gutter="4">
						<el-col :span="8">
							<el-form-item label="账号类型" :label-width="formLabelWidth">
								<el-select
									v-model="queryBankInfo.acountsType"
									placeholder="请选择"
								>
									<el-option
						...
						<el-col :span="8">
							<el-form-item label="账户名" :label-width="formLabelWidth">
								<el-input
									v-model="queryBankInfo.acountsName"
									autocomplete="off"
								></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="3">
							<el-button type="primary" @click="handleSearchBankInfo">
								搜索
							</el-button>
						</el-col>
					</el-row>
				...
				<el-row>
					<el-table v-loading="loading" :data="bankInfo">
						...
						>
							<template slot-scope="scope">
								<el-button type="danger" @click="addThisBankInfo(scope.row)">
									添加该银行卡
								</el-button>
							</template>
						</el-table-column>
				...
				<div slot="footer" class="dialog-footer">
					...
					<el-button type="primary" @click="dialogBankInfoVisible = false">
						确 定
					</el-button>
				</div>
				<pagination
...
export default {
	...
	data() {
		...
		return {
			...
			rules: {
				...
				city: [{ required: true, validator: validateRegion, trigger: 'change' }]
	...
	created() {
		this.getList();
		if (
			localStorage.getItem('company-columns') === 'null' ||
