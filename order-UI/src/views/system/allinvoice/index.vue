<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-horizontal-scroll="'always'" v-loading="loading" border :data="invoiceInList"
              :cell-style="()=>{return {padding:'2px'}}" size="mini" @selection-change="handleSelectionChange">
      <el-table-column v-if="columns[0].visible" label="id" align="center" prop="id" width="140" />
      <el-table-column v-if="columns[1].visible" label="开票日期" align="center" prop="invoiceDate" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[2].visible" label="发票金额" align="center" prop="invoiceAmount" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[3].visible" label="公司类型" align="center" prop="companyType" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[4].visible" label="公司名称" align="center" prop="companyName" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[5].visible" label="开票单位名称" align="center" prop="invoiceCompanyName" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[6].visible" label="票点" align="center" prop="ticketPoint" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[7].visible" label="票点金额" align="center" prop="ticketPointAmount" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[8].visible" label="是否为订单税" align="center" prop="isOrderTax" width="140"
                       show-overflow-tooltip>
      ...
      <el-table-column v-if="columns[9].visible" label="供应商名称" align="center" prop="supplier" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[10].visible" label="客户名称" align="center" prop="customer" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[11].visible" label="采购发票金额" align="center" prop="purchaseInvoiceAmount"
                       width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[12].visible" label="票点成本（点数）" align="center" prop="ticketPointCost" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[13].visible" label="票点成本（金额）" align="center" prop="ticketPointCostAmount"
                       width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[14].visible" label="票点收入（点数）" align="center" prop="ticketPointIncome" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[15].visible" label="票点收入（金额）" align="center" prop="ticketPointIncomeAmount"
                       width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[16].visible" label="票点差额" align="center" prop="ticketPointDifference" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[17].visible" label="总货款" align="center" prop="allPayments" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[18].visible" label="实际开票日期" align="center" prop="orderDate" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[19].visible" label="当月欠票" align="center" prop="oweamount" width="140"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[20].visible" label="备注" align="center" prop="comments" width="140"
                       show-overflow-tooltip />
    </el-table>
