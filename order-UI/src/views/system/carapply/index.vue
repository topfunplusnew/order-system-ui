<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="carApplyList"
              size="mini" :cell-style="()=>{return {padding:'2px'}}" @selection-change="handleSelectionChange">
      <el-table-column v-if="columns[0].visible" label="申请时间" align="center"
                       prop="applyDate" show-overflow-tooltip />
      <el-table-column v-if="columns[1].visible" label="申请人" align="center"
                       prop="applyUser" show-overflow-tooltip />
      <el-table-column v-if="columns[2].visible" label="部门" align="center"
                       prop="department" show-overflow-tooltip />
      <el-table-column v-if="columns[3].visible" label="车牌" align="center"
                       prop="carNo" show-overflow-tooltip />
      <el-table-column v-if="columns[4].visible" label="是否携带油卡" align="center"
                       prop="isUseOilCard" show-overflow-tooltip />
      <el-table-column v-if="columns[5].visible" label="随同乘车人员" align="center"
                       prop="peers" show-overflow-tooltip />
      <el-table-column v-if="columns[6].visible" label="用车时间" align="center"
                       prop="startTime" show-overflow-tooltip />
      <el-table-column v-if="columns[7].visible" label="还车时间" align="center"
                       prop="endTime" show-overflow-tooltip />
      <el-table-column v-if="columns[8].visible" label="用车事由" align="center"
                       prop="applyPurpose" show-overflow-tooltip />
      <el-table-column v-if="columns[9].visible" label="出车前里程" align="center"
                       prop="startMile" show-overflow-tooltip />
      <el-table-column v-if="columns[10].visible" label="出车前车况" align="center"
                       prop="startCarState" show-overflow-tooltip />
      <el-table-column v-if="columns[11].visible" label="回来后里程" align="center"
                       prop="endMile" show-overflow-tooltip />
      <el-table-column v-if="columns[12].visible" label="回来后车况" align="center"
                       prop="endCarState" show-overflow-tooltip />
      <el-table-column v-if="columns[13].visible" label="用车里程数" align="center"
                       prop="miles" show-overflow-tooltip />
      <el-table-column v-if="columns[14].visible" label="回程停靠位置" align="center"
                       prop="backStopPlace" show-overflow-tooltip />
      <el-table-column v-if="columns[15].visible" label="行程中违法次数" align="center"
                       prop="violationsCount" show-overflow-tooltip />
      <el-table-column v-if="columns[16].visible" label="违章罚款金额" align="center"
                       prop="fine" show-overflow-tooltip />
      <el-table-column v-if="columns[17].visible" label="行程中是否维修/保养" align="center"
                       prop="isMaintenance" show-overflow-tooltip />
      <el-table-column v-if="columns[18].visible" label="保养金额" align="center"
                       prop="maintenanceMoney" show-overflow-tooltip />
      <el-table-column v-if="columns[19].visible" label="行程中使用加油卡加油次数" align="center"
                       prop="refuelingFrequency" show-overflow-tooltip />
      <el-table-column v-if="columns[20].visible" label="派车人" align="center"
                       prop="dispatchPerson" show-overflow-tooltip />
      <el-table-column v-if="columns[21].visible" label="备注" align="center"
                       prop="comments" show-overflow-tooltip />
      <el-table-column v-if="columns[22].visible" label="附件路径" align="center" prop="path">
          ...
          <el-col :span="12">
            ...
            <el-form-item label="使用加油卡车辆车牌号" prop="carNo">
              <el-row>
                ...
                <el-col :span="4">
                  <SearchOption :get-data="listData" query-info="dictLabel" :query-name="queryCarNumber"
                                query-label="车牌号查询" :limit-info="{dictType: 'order_cars'}"
            ...
            <el-form-item v-if="isRecharge === '1'" label="充值金额" prop="rechargeMoney">
            ...
            <el-row>
              <el-form-item label="加油小票附件" prop="attachmentOiladd">
                <el-row>
                  ...
                  <el-col v-if="oilCardConsumeInfo.attachmentOiladd !== null && oilCardConsumeInfo.attachmentOiladd !== ''"
                          :span="4">
