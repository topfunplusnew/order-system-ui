...
<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'"
              border :data="totalList" size="mini" :cell-style="()=>{return {padding:'2px'}}">
      <el-table-column v-if="columns[0].visible" label="日期" align="center" prop="time" show-overflow-tooltip />
      <el-table-column v-if="columns[1].visible" label="销售经理名称" align="center" prop="salesManager"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[3].visible" label="发货车数" align="center" prop="uniqueOrderCount"
                       show-overflow-tooltip>
      </el-table-column>
      <el-table-column v-if="columns[2].visible" label="不含税利润" align="center" prop="totalProfit"
                       show-overflow-tooltip />
    </el-table>
