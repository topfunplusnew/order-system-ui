      ...
      <el-col :span="20">
        <el-table border v-horizontal-scroll="'always'" v-loading="loading" :data="inventoryList"
          ...
          <el-table-column label="陆运司机电话" align="center" prop="landDriverTel" v-if="columns[21].visible"
                           width="150"/>
          <el-table-column label="陆地司机姓名" align="center" prop="landDriverName" v-if="columns[22].visible"
                           width="150"/>
          ...
          <el-table-column label="陆运费单价" align="center" prop="landFreightPrice" v-if="columns[25].visible"
                           width="150"/>
          ...
          <el-table-column label="总货款杂费" align="center" prop="paymentsWithSundry" v-if="columns[31].visible"
                           width="150"/>
