<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" v-horizontal-scroll="'always'" :data="OffsettingList" size="mini"
              :cell-style="()=>{return {padding:'.5px'}}" border @selection-change="handleSelectionChange">
      <el-table-column label="id" align="center" prop="id" />
      <el-table-column v-if="columns[0].visible" label="冲抵编号" align="center" prop="pffsetNO" show-overflow-tooltip />
      <el-table-column v-if="columns[1].visible" label="操作时间" align="center" prop="operateDate"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[2].visible" label="冲抵类型" align="center" prop="operateType"
                       show-overflow-tooltip />
      ...
      <el-table-column v-if="columns[5].visible" label="公司类型" align="center" prop="companyType"
                       show-overflow-tooltip>
