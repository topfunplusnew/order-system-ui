<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" v-horizontal-scroll="'always'" id="printBox" border :data="bankAcceptanceList"
              ...
              height="480px" :cell-style="()=>{return {padding:'.5px'}}" @selection-change="handleSelectionChange">
      <el-table-column label="id" align="center" prop="id" />
      <el-table-column v-if="columns[0].visible" label="操作日期" align="center" prop="operateDate"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[10].visible" label="票据种类" align="center" prop="billCategory"
                       show-overflow-tooltip />
      ...
      <el-table-column v-if="columns[6].visible" label="收票事由" align="center" prop="reason" show-overflow-tooltip />
      <el-table-column label="背书人" align="center" prop="endorser" show-overflow-tooltip />
      <el-table-column v-if="columns[2].visible" label="出票日期" align="center" prop="issueDate"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[3].visible" label="到期日期" align="center" prop="dueDate" show-overflow-tooltip />
      <el-table-column v-if="columns[4].visible" label="我方承兑账户" align="center" prop="billAccount"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[5].visible" label="票据交易日期" align="center" prop="billDate"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[7].visible" label="票据金额" align="center" prop="billAmount"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[8].visible" label="贴息点数" align="center" prop="inDiscountPoints"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[9].visible" label="贴息金额" align="center" prop="inDiscountAmount"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[11].visible" label="来源" align="center" prop="origin" show-overflow-tooltip />
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { key: 12, label: `背书事由`, visible: true },
        ],
        // 表单参数
        form: {},
        // 表单校验
