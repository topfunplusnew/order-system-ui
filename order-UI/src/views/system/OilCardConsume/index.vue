<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border
              :data="OilCardConsumeList" size="mini" :cell-style="()=>{return {padding:'2px'}}" @selection-change="handleSelectionChange">
...
<script>
  ...
  export default {
    ...
    created() {
      this.getList();
      if (localStorage.getItem('oilcardconsume-columns') === 'null' ||
