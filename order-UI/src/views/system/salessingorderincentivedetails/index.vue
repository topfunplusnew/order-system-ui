<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" v-horizontal-scroll="'always'" :data="salessingorderincentivedetailsList"
      ...
      <el-table-column v-if="columns[1].visible" label="订单日期" align="center" prop="orderDate" width="180"
      ...
      <el-table-column v-if="columns[2].visible" label="接受奖励人员" align="center" prop="rewardReceiver"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[3].visible" label="订单不含税利润" align="center" prop="orderProfit"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[4].visible" label="厂家返利" align="center" prop="manufacturerRebate"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[5].visible" label="客户佣金" align="center" prop="customerCommission"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[6].visible" label="综合单车利润" align="center" prop="comprehensiveProfit"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[7].visible" label="奖励金额" align="center" prop="rewardAmount"
                       show-overflow-tooltip />

      <el-table-column v-if="columns[8].visible" label="奖励日期" align="center" prop="rewardDate" width="180"
                       show-overflow-tooltip>
        <template #default="scope">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('system/salessingorderincentivedetails/export', {
          ...this.queryParams
