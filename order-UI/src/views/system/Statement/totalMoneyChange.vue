	...
	methods: {
		...
		formatTableData(data) {
			return [
				...
				{ label: '②所有银行卡资金合计', value: data.selfCompanyTotalFunds },
				...
				{ label: '⑥其他应收-个人从公司借款', value: data.loanFromCompany },
				{ label: '⑦公司从外面借款合计', value: data.loanBalance },
				{ label: '客户票点合计', value: data.companyTotalInvoiceAmount },
				{ label: '供应商票点合计', value: data.supplierTotalInvoiceAmount }
			];
		},
