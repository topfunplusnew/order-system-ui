    ...
    <div class="app-container">
      ...
      <el-row>
        ...
        <el-row>
          ...
          <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="statementList"
                    show-summary :summary-method="getSummaries" size="mini"
                    :cell-style="()=>{return {padding:'2px'}}" fit>
            <el-table-column v-if="columns[0].visible" label="日期" align="center" prop="time" width="200"
            />
            <el-table-column v-if="columns[1].visible" label="户名" align="driverName" prop="acountsName"
                             width="200" />
            <el-table-column v-if="columns[2].visible" label="银行账号" align="center" prop="bankNo"
                             width="200" />
            <el-table-column v-if="columns[3].visible" label="上日余额" align="center" prop="previousDayBalance"
                             width="200" />
            <el-table-column v-if="columns[4].visible" label="本日收款" align="center" prop="dailyReceipts"
                             width="200" />
            <el-table-column v-if="columns[5].visible" label="本日付款" align="center" prop="dailyPayments"
                             width="200" />
