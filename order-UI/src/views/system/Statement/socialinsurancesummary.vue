<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'"
              border :data="socialInsuranceList" size="mini" :cell-style="()=>{return {padding:'.5px'}}">
      ...
      <el-table-column v-if="columns[0].visible" label="社保缴纳基数" align="center" prop="basicSocialInsurance"
                       width="110" />
      ...
      <el-table-column label="基本医疗保险" align="center">
        ...
        <el-table-column v-if="columns[9].visible" label="公司缴纳" align="center"
      ...
      <el-table-column label="失业保险" align="center">
        <el-table-column v-if="columns[11].visible" label="个人缴纳" align="center"
                         prop="unemploymentSecuritySelf" />
        <el-table-column v-if="columns[12].visible" label="公司缴纳" align="center"
      ...
      <el-table-column label="养老保险" align="center">
        ...
        <el-table-column v-if="columns[14].visible" label="公司缴纳" align="center"
                         prop="retirementSecurityCompany" />
      </el-table-column>
      <el-table-column label="大额医保" align="center">
        <el-table-column v-if="columns[15].visible" label="个人缴纳" align="center"
                         prop="largeMedicalSecuritySelf" />
        <el-table-column v-if="columns[16].visible" label="公司缴纳" align="center"
