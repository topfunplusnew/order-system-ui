...
<template>
	<div class="app-container">
		...
		>
			...
			/>
			<el-table-column
				v-if="columns[2] && columns[2].visible"
				show-overflow-tooltip
				label="上日欠款结转"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[3] && columns[3].visible"
				show-overflow-tooltip
				label="本日欠款余额"
				align="center"
			...
			<el-table-column
				v-if="columns[4] && columns[4].visible"
				show-overflow-tooltip
				label="本日发货金额"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[5] && columns[5].visible"
				show-overflow-tooltip
				label="购入票点"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[6] && columns[6].visible"
				show-overflow-tooltip
				label="本日付款金额"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[7] && columns[7].visible"
				show-overflow-tooltip
				label="上月结转欠款金额"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[8] && columns[8].visible"
				show-overflow-tooltip
				label="本月发货金额"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[9] && columns[9].visible"
				show-overflow-tooltip
				label="本月购入票点"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[10] && columns[10].visible"
				show-overflow-tooltip
				label="本月付款金额合计"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[11] && columns[11].visible"
				show-overflow-tooltip
				label="本月欠款"
				align="center"
			...
			<el-table-column
				v-if="columns[12] && columns[12].visible"
				show-overflow-tooltip
				label="上年结转"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[13] && columns[13].visible"
				show-overflow-tooltip
				label="本年发货金额"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[14] && columns[14].visible"
				show-overflow-tooltip
				label="本年购入票点"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[15] && columns[15].visible"
				show-overflow-tooltip
				label="本年付款金额"
				align="center"
			...
			/>
			<el-table-column
				v-if="columns[16] && columns[16].visible"
				show-overflow-tooltip
				label="欠款"
				align="center"
