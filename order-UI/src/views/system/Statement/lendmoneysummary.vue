...
<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'"
      ...
      <el-table-column v-if="columns[0].visible" label="借款人" align="center"
                       prop="target" width="110" />
      <el-table-column v-if="columns[1].visible" label="对象" align="center"
      ...
      <el-table-column v-if="columns[9].visible" label="支付员工/外面公司在我公司借款时间" align="center"
                       prop="futuresDate" width="160" />
