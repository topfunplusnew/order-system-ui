  ...
  <div class="app-container">
    ...
    <el-table border v-loading="loading" :data="tableData"
      ...
      <el-table-column show-overflow-tooltip label="期初余额" align="center" prop="beginningBalance"
                       width="140"/>
      <el-table-column show-overflow-tooltip label="借方(付供应商货款)" align="center" prop="positiveSum"
                       width="140"/>
      <el-table-column show-overflow-tooltip label="贷方(从厂家提货)" align="center" prop="negativeSum"
                       width="140"/>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listConfig({configKey: 'order.supplierDetailSummary.subjectNo'}).then(res => {
