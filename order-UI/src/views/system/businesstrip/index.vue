<template>
  <div class="app-container">
    ...
    <el-table v-horizontal-scroll="'always'" v-loading="loading" size="mini" border :data="BusinessTripList"
              :cell-style="()=>{return {padding:'2px'}}" @selection-change="handleSelectionChange">
        ...
        <template #step-two>
          ...
          <el-row v-if="useCar ==='是'" style="margin: 20px 0">
            <el-card class="box-card">
              ...
              <div v-if="!hasCarApplyInfo" style="text-align: center;color: #999">
                暂无车辆信息
              </div>
              <div v-else>
                <el-descriptions>
          ...
          <el-table ref="tripReimbursement" :data="tripReimbursementList"
                    :row-class-name="rowTripReimbursementIndex" @selection-change="handleTripReimbursementSelectionChange">
    ...
    <el-dialog :close-on-click-modal="false" :show-close="false"
      ...
      <keep-alive>
        <ApplyPayment :table-name="TableName.BUSINESS_TRIP"
                      :t-i-d="tID"
                      :need-info="{}" :need-money="needMoney" @changeOpen="changePaymentApplyInfoVisible" />
      </keep-alive>
    </el-dialog>
