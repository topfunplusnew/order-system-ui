  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="供应商票点" prop="supplierTicketPoint">
        <el-input
          v-model="queryParams.supplierTicketPoint"
      ...
      <el-form-item label="供应商票点金额" prop="supplierPointAmount">
        <el-input
          v-model="queryParams.supplierPointAmount"
      ...
      <el-form-item label="客户票点" prop="customerTicketPoint">
        <el-input
          v-model="queryParams.customerTicketPoint"
          placeholder="请输入客户票点"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="票点金额" prop="customerPointAmount">
        <el-input
          v-model="queryParams.customerPointAmount"
          placeholder="请输入票点金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="invoiceOtherList" @selection-change="handleSelectionChange">
...
<script>
import { listInvoiceOther, getInvoiceOther, delInvoiceOther, addInvoiceOther, updateInvoiceOther } from "@/api/system/invoiceOther";
