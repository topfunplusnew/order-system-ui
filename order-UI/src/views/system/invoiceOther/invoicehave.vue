<template>
  <div class="app-container">
    ...
    <el-table v-horizontal-scroll="'always'" v-loading="loading" border :data="invoiceOtherList"
              size="mini"
              :cell-style="()=>{return {padding:'.5px'}}" @header-dragend="changeColWidth" @selection-change="handleSelectionChange">
      ...
      <el-table-column v-if="columns[4].visible" label="供应商公司名称" align="center" prop="Supplier"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[5].visible" label="订单信息" align="center" prop="isOrderTax" width="180"
                       show-overflow-tooltip>
