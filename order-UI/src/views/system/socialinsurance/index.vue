<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border
              :data="socialInsuranceList" size="mini" :cell-style="()=>{return {padding:'.5px'}}" @selection-change="handleSelectionChange">
      ...
      <el-table-column v-if="columns[2].visible" label="人员编号" align="center" prop="employeeID"
                       show-overflow-tooltip />
      <el-table-column v-if="columns[3].visible" label="社保缴纳基数" align="center" prop="basicSocialInsurance"
                       show-overflow-tooltip
                       width="110" />
      <el-table-column v-if="columns[4].visible" label="公积金基数" align="center" prop="basicHousingFund" width="110"
                       show-overflow-tooltip />
      ...
      <el-table-column v-if="columns[21].visible" label="备注" align="center" prop="comments" width="120" />
