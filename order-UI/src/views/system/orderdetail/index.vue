<template>
  <div class="app-container">
    <!--    查询组-->
    <el-form v-show="showSearch" ref="queryForm" :model="queryOrderInfo" size="small" :inline="true"
             label-width="100px">
    </el-form>
    <!--       表格上方操作栏-->
    ...
    <el-table id="printBox"
              ...
              :data="orderDetailList" :row-class-name="tableRowClassName"
              show-summary
              :summary-method="getSummaries" max-height="700"
