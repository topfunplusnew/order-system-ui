<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="mini" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="原订单ID" prop="goodsOrderID">
        <el-input
      ...
      <el-form-item label="打款状态(已打款，未打款)" prop="PaymentState">
        <el-input
          v-model="queryParams.PaymentState"
          placeholder="请输入打款状态(已打款，未打款)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="backList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="原订单ID" align="center" prop="goodsOrderID" />
      ...
      <el-table-column label="打款状态(已打款，未打款)" align="center" prop="PaymentState" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="原订单ID" prop="goodsOrderID">
          <el-input v-model="form.goodsOrderID" placeholder="请输入原订单ID" />
        </el-form-item>
        <el-form-item label="订单编号" prop="ordersNo">
        ...
        <el-form-item label="打款状态(已打款，未打款)" prop="PaymentState">
          <el-input v-model="form.PaymentState" placeholder="请输入打款状态(已打款，未打款)" />
        </el-form-item>
        <el-form-item label="陆运银行户名" prop="landBankName">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除订单备份编号为"' + ids + '"的数据项？').then(function() {
        return delBack(ids);
      }).then(() => {
        this.getList();
