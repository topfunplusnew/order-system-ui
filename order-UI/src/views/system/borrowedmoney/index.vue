<template>
  <div class="app-container">
    ...
    <el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border
              :data="borrowedMoneyList" show-summary :summary-method="getSummaries" size="mini" :cell-style="()=>{return {padding:'.5px'}}"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="160px" fixed="right">
        <template slot-scope="scope">
          <el-button
            ...
            size="mini"
            type="warning"
            @click="handleGiveBackMoney(scope.row)">还款
          </el-button>
          <el-button
            v-if="scope.row.isEnd === '1'"
            size="mini"
            type="success"
            @click="handleGiveEnoughBackMoney(scope.row)">已还款
          </el-button>
          <el-button
