  ...
  <div>
    <el-card>
      <el-descriptions title="库存信息">
        ...
        <el-descriptions-item label="产品规格">{{ needToShowInfo.levelName }} - {{
            needToShowInfo.countingUnit
          }}
        </el-descriptions-item>
        <el-descriptions-item label="单片尺寸">{{ needToShowInfo.height }} × {{ needToShowInfo.length }} ×
          {{ needToShowInfo.width }} cm
        </el-descriptions-item>
        <el-descriptions-item label="每包数量">{{ needToShowInfo.piecesPerPack }}</el-descriptions-item>
        <el-descriptions-item label="包装总数">{{ needToShowInfo.packs }}</el-descriptions-item>
