  ...
  <div>
    <el-card>
      <el-descriptions title="订单详情" column="3">
        ...
        <el-descriptions-item label="等级">{{ needToShowInfo.levelName }}</el-descriptions-item>
        <el-descriptions-item label="计量单位">{{ needToShowInfo.countingUnit }}</el-descriptions-item>
        <el-descriptions-item label="高度">{{ needToShowInfo.height }} m</el-descriptions-item>
        <el-descriptions-item label="长度">{{ needToShowInfo.length }} mm</el-descriptions-item>
        <el-descriptions-item label="宽度">{{ needToShowInfo.width }} mm</el-descriptions-item>
        ...
        <el-descriptions-item label="吨数">{{ needToShowInfo.tonnage }} 吨</el-descriptions-item>
        <el-descriptions-item label="陆运价">{{ needToShowInfo.landFreightPrice }} 元</el-descriptions-item>
        <el-descriptions-item label="陆运费">{{ needToShowInfo.landFreight }} 元</el-descriptions-item>
        <el-descriptions-item label="海运费">{{ needToShowInfo.seaFreight || '无' }} 元</el-descriptions-item>
        <el-descriptions-item label="运费总计">{{ needToShowInfo.freight }} 元</el-descriptions-item>
        ...
        <el-descriptions-item label="调整标志">{{ needToShowInfo.isAdjusted ? '是' : '否' }}</el-descriptions-item>
