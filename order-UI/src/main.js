...
Vue.prototype.$excludeWithUpdate = ['addtime', 'userId', 'delFlag', 'id', 'orderDetailList', 'goodsOrderID', 'ordersNo', 'customerID', 'checkUserId', 'checkState', 'isAdjust', 'adjustDate', 'isAdjusted', 'adjustOrderid', 'receiveProof', 'paymentState', 'invoiceState', 'customerIsInvoice', 'isSupplierInvoice', 'orderDateEnd', 'orderDateStart', 'landCarID', 'seaCarID', 'path', 'submitflag', 'cancelFlag', 'createBy', 'createTime', 'updateBy', 'isedit',]
