...
<template>
  <div class="inventory-change-template">
    <el-table
      :data="tableData"
      border
    ...
    >
      ...
      <el-table-column label="入库时间" prop="inboundTime" width="150" />
      <el-table-column label="仓库" prop="warehouse" width="120" />
      <el-table-column label="陆运车牌" prop="truckPlate" width="120" />
      ...
      <el-table-column label="库存量(片数)" prop="inventoryPieces" width="120" />
    ...
    compareData: [
      {
        ...
        changeType: 'before',
        status: '已入库',
        inboundTime: '2026-01-15',
        warehouse: '刘彦波仓库',
        // ... 其他字段
        inventoryAmount: 8979.77,
        supplierAmount: 5000.00,
