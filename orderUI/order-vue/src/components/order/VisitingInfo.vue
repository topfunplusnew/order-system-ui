  ...
  <div style="height: 800px">
    ...
    >
      ...
      <template v-slot:toolbar>
        <lay-button size="sm" type="primary" @click="handleAdd"
          >新增车辆信息</lay-button
        >
        <lay-button size="sm" @click="remove">删除</lay-button>
        <lay-input
          :allow-clear="true"
          v-model="valueInputNumber"
          style="width: 150px; height: 33px; margin-left: 10px"
          placeholder="请输入车牌"
        ></lay-input>
        <lay-input
          :allow-clear="true"
          v-model="valueInputName"
          style="width: 150px; height: 33px; margin-left: 10px"
          placeholder="请输入户名"
        ></lay-input>
      ...
      <template v-slot:operator="{ row }">
        <lay-button size="xs" type="primary" @click="changeVisible(row)"
          >编辑</lay-button
        >
    ...
    >
      <div style="padding: 20px">
        <lay-form :model="modelPop" ref="layFormRef11" required>
          <lay-form-item label="用户名" prop="name"> </lay-form-item>
        </lay-form>
      </div>
    </lay-layer>
