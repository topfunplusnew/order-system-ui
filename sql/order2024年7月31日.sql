...
CREATE TABLE `StoreHouse`  (
  ...
  `delFlag` int(11) NULL DEFAULT 0 COMMENT '删除标记',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '库房' ROW_FORMAT = Dynamic;
...
INSERT INTO `bankAccount` VALUES (15, '山东省某科技有限公司', 999, '中国工商银行济南分行', '山东省某科技有限公司', '6222001234567890', '其它', 100000, '公司主要银行账户', 0);
INSERT INTO `bankAccount` VALUES (16, '山东省某科技有限公司', 999, '中国工商银行济南分行', '山东省某科技有限公司', '6222001234567890', '其它', 100000, '公司主要银行账户', 0);
...
CREATE TABLE `fleet`  (
  ...
  `delFlag` int(11) NULL DEFAULT 0 COMMENT '删除标记',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '车队' ROW_FORMAT = Dynamic;
...
INSERT INTO `fleet` VALUES (5, '&', 'yx*vdiv21^)p^&', '18638478643', '&S2@gg*FVj', 'Tue Jul 30 23:29:18 CST 2024', NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 286 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 633 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
