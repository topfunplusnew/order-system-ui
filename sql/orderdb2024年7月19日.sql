...
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `gen_table` VALUES (78, 'goodsorder', '订单', NULL, NULL, 'Goodsorder', 'crud', '', 'com.ruoyi.system', 'system', 'goodsorder', '订单', 'ruoyi', '0', '/', NULL, 'admin', '2024-07-19 10:47:09', '', NULL, NULL);
...
INSERT INTO `gen_table` VALUES (86, 'orderdetail', '订单详情', NULL, NULL, 'Orderdetail', 'crud', '', 'com.ruoyi.system', 'system', 'orderdetail', '订单详情', 'ruoyi', '0', '/', NULL, 'admin', '2024-07-19 10:47:10', '', NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1974 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '代码生成业务表字段' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `gen_table_column` VALUES (1455, 78, 'id', NULL, 'int(11)', 'Long', 'id', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1456, 78, 'ordersNo', '订单编号（UUID）', 'varchar(50)', 'String', 'ordersNo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1457, 78, 'orderDate', '日期', 'varchar(50)', 'String', 'orderDate', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1458, 78, 'customer', '客户', 'varchar(150)', 'String', 'customer', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1459, 78, 'customer_id', '客户ID', 'int(11)', 'Long', 'customerId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1460, 78, 'landCar_id', '陆运车辆ID', 'int(11)', 'Long', 'landcarId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1461, 78, 'landCarNo', '陆运车牌', 'varchar(50)', 'String', 'landCarNo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1462, 78, 'landDriverTel', '陆运司机电话', 'varchar(50)', 'String', 'landDriverTel', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1463, 78, 'landDriverName', '陆地司机姓名', 'varchar(55)', 'String', 'landDriverName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 9, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1464, 78, 'seaCar_id', '海运车辆ID', 'int(11)', 'Long', 'seacarId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1465, 78, 'seaCarNo', '海运车牌', 'varchar(50)', 'String', 'seaCarNo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1466, 78, 'seaDriverTel', '海运司机电话', 'varchar(50)', 'String', 'seaDriverTel', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 12, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1467, 78, 'seaDriverName', '海运司机姓名', 'varchar(55)', 'String', 'seaDriverName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 13, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1468, 78, 'checkUserId', '审核人编号', 'int(11)', 'Long', 'checkUserId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 14, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1469, 78, 'checkState', '审核状态（已审核、未审核）', 'varchar(20)', 'String', 'checkState', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 15, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1470, 78, 'invoiceState', '开票状态（未开票，部分开票，已开票）', 'varchar(20)', 'String', 'invoiceState', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 16, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1471, 78, 'path', '附件路径', 'varchar(250)', 'String', 'path', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 17, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1472, 78, 'PaymentState', '打款状态(申请中，已打款，未打款)', 'varchar(20)', 'String', 'PaymentState', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 18, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1473, 78, 'landBankName', '陆运银行户名', 'varchar(50)', 'String', 'landBankName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 19, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1474, 78, 'landBankNo', '陆运银行账号', 'varchar(50)', 'String', 'landBankNo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 20, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1475, 78, 'seaBankName', '海运银行户名', 'varchar(50)', 'String', 'seaBankName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 21, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1476, 78, 'seaBankNo', '海运银行账号', 'varchar(50)', 'String', 'seaBankNo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 22, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1477, 78, 'receiveProof', '收到条附件路径', 'text', 'String', 'receiveProof', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'textarea', '', 23, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1478, 78, 'saleManager', '销售经理', 'varchar(25)', 'String', 'saleManager', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 24, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1479, 78, 'fleet', '车队', 'varchar(50)', 'String', 'fleet', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 25, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1480, 78, 'isAdjusted', '是否被调整单（ 是  否）', 'varchar(10)', 'String', 'isAdjusted', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 26, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1481, 78, 'adjustDate', '调整日期', 'varchar(50)', 'String', 'adjustDate', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 27, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1482, 78, 'isAdjust', '是否调整单（是  否）', 'varchar(10)', 'String', 'isAdjust', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 28, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1483, 78, 'adjustOrderid', '原订单编号', 'int(11)', 'Long', 'adjustOrderid', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 29, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1484, 78, 'isedit', '是否可编辑', 'int(11)', 'Long', 'isedit', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 30, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1485, 78, 'customerIsInvoice', '客户是否开票', 'int(11)', 'Long', 'customerIsInvoice', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 31, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1486, 78, 'isSupplierInvoice', '供应商是否开票', 'int(11)', 'Long', 'isSupplierInvoice', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 32, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1487, 78, 'cancelFlag', '作废标记', 'int(11)', 'Long', 'cancelFlag', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 33, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1488, 78, 'comments', '备注', 'varchar(200)', 'String', 'comments', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 34, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1489, 78, 'addtime', '添加时间', 'varchar(50)', 'String', 'addtime', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 35, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1490, 78, 'userId', '操作人员ID', 'int(11)', 'Long', 'userId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 36, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1491, 78, 'UserName', '操作人员姓名', 'varchar(50)', 'String', 'UserName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 37, 'admin', '2024-07-19 10:47:09', '', NULL);
INSERT INTO `gen_table_column` VALUES (1492, 78, 'update_time', '更新时间', 'datetime', 'Date', 'updateTime', '0', '0', '0', '1', '1', NULL, NULL, 'EQ', 'datetime', '', 38, 'admin', '2024-07-19 10:47:09', '', NULL);
...
INSERT INTO `gen_table_column` VALUES (1698, 86, 'id', NULL, 'int(11)', 'Long', 'id', '1', '1', '0', '1', NULL, NULL, NULL, 'EQ', 'input', '', 1, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1699, 86, 'ordersNo', '订单编号（UUID）', 'varchar(50)', 'String', 'ordersNo', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 2, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1700, 86, 'orderDate', '订单日期', 'varchar(50)', 'String', 'orderDate', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 3, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1701, 86, 'supplier', '供应商', 'varchar(150)', 'String', 'supplier', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 4, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1702, 86, 'supplier_id', '供应商ID', 'int(11)', 'Long', 'supplierId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 5, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1703, 86, 'customer', '客户', 'varchar(150)', 'String', 'customer', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 6, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1704, 86, 'customer_id', '客户ID', 'int(11)', 'Long', 'customerId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 7, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1705, 86, 'levelID', '级别编码', 'int(11)', 'Long', 'levelID', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 8, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1706, 86, 'levelName', '级别名称', 'varchar(80)', 'String', 'levelName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 9, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1707, 86, 'countingUnit', '计量单位', 'varchar(25)', 'String', 'countingUnit', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 10, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1708, 86, 'height', '厚度', 'float', 'Long', 'height', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 11, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1709, 86, 'length', '长度', 'float', 'Long', 'length', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 12, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1710, 86, 'width', '宽度', 'float', 'Long', 'width', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 13, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1711, 86, 'pieces', '出厂片数', 'int(11)', 'Long', 'pieces', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 14, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1712, 86, 'piecesPerPack', '每包片数', 'int(11)', 'Long', 'piecesPerPack', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 15, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1713, 86, 'packs', '包数', 'int(11)', 'Long', 'packs', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 16, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1714, 86, 'price', '出厂单价', 'float', 'Long', 'price', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 17, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1715, 86, 'isIncludeTaxFactory', '出厂是否含税', 'int(11)', 'Long', 'isIncludeTaxFactory', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 18, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1716, 86, 'sundryCost', '杂费', 'float', 'Long', 'sundryCost', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 19, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1717, 86, 'paymentFactory', '出厂货款', 'float', 'Long', 'paymentFactory', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 20, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1718, 86, 'paymentUnload', '卸货价', 'float', 'Long', 'paymentUnload', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 21, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1719, 86, 'isIncludeTaxSale', '销售是否含税', 'int(11)', 'Long', 'isIncludeTaxSale', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 22, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1720, 86, 'payments', '总货款', 'float', 'Long', 'payments', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 23, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1721, 86, 'erro', '误差', 'float', 'Long', 'erro', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 24, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1722, 86, 'tonnage', '吨位', 'float', 'Long', 'tonnage', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 25, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1723, 86, 'landFreightPrice', '陆运费单价', 'float', 'Long', 'landFreightPrice', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 26, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1724, 86, 'landFreight', '陆运费', 'float', 'Long', 'landFreight', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 27, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1725, 86, 'seaFreight', '海运费', 'float', 'Long', 'seaFreight', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 28, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1726, 86, 'freight', '总运费', 'float', 'Long', 'freight', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 29, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1727, 86, 'otherCost', '其他费用', 'float', 'Long', 'otherCost', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 30, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1728, 86, 'profit', '利润', 'float', 'Long', 'profit', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 31, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1729, 86, 'profitNoTax', '不含税利润', 'float', 'Long', 'profitNoTax', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 32, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1730, 86, 'actualPieces', '实际片数', 'int(11)', 'Long', 'actualPieces', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 33, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1731, 86, 'paymentsWithSundry', '总货款杂费', 'float', 'Long', 'paymentsWithSundry', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 34, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1732, 86, 'additionalFees', '加费', 'float', 'Long', 'additionalFees', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 35, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1733, 86, 'storeHouseID', '仓库ID', 'int(11)', 'Long', 'storeHouseID', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 36, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1734, 86, 'storeHouseName', '仓库名称', 'varchar(100)', 'String', 'storeHouseName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 37, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1735, 86, 'storeID', '仓库存储的货物ID', 'int(11)', 'Long', 'storeID', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 38, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1736, 86, 'logisticsProfit', '物流利润', 'float', 'Long', 'logisticsProfit', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 39, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1737, 86, 'customerCommission', '客户佣金', 'float', 'Long', 'customerCommission', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 40, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1738, 86, 'isAdjusted', '是否被调整单（ 是  否）', 'varchar(10)', 'String', 'isAdjusted', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 41, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1739, 86, 'adjustDate', '调整日期', 'varchar(50)', 'String', 'adjustDate', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 42, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1740, 86, 'cancelFlag', '作废标记', 'int(11)', 'Long', 'cancelFlag', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 43, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1741, 86, 'comments', '备注', 'varchar(200)', 'String', 'comments', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 44, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1742, 86, 'addtime', '添加时间', 'varchar(50)', 'String', 'addtime', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 45, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1743, 86, 'userId', '操作人员ID', 'int(11)', 'Long', 'userId', '0', '0', '0', '1', '1', '1', '1', 'EQ', 'input', '', 46, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1744, 86, 'UserName', '操作人员姓名', 'varchar(50)', 'String', 'UserName', '0', '0', '0', '1', '1', '1', '1', 'LIKE', 'input', '', 47, 'admin', '2024-07-19 10:47:10', '', NULL);
INSERT INTO `gen_table_column` VALUES (1745, 86, 'update_time', '更新时间', 'datetime', 'Date', 'updateTime', '0', '0', '0', '1', '1', NULL, NULL, 'EQ', 'datetime', '', 48, 'admin', '2024-07-19 10:47:10', '', NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, NULL, 'admin', 'admin', '00', '', '0', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-07-19 10:29:35', '', NULL, '', '2024-07-19 10:29:35', NULL, 'admin', 'admin', '1', '', '', '', '', '', '', '', '', '', 'asd', 'asd', 'asd', 'awsd', 'awd', 'awsda', 'awsd', 'awsd', 'awsd');
