<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="收付款类型" prop="payCategory">
        <el-input
          v-model="queryParams.payCategory"
          placeholder="请输入收付款类型"
          clearable
    ...
    <el-table v-loading="loading" :data="paymentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="收付款类型" align="center" prop="payCategory" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="收付款类型" prop="payCategory">
          <el-input v-model="form.payCategory" placeholder="请输入收付款类型" />
        </el-form-item>
        <el-form-item label="付款编号" prop="payNO">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除收付款信息编号为"' + ids + '"的数据项？').then(function() {
