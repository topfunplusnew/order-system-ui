...
export default {
	...
	computed: {
		 ...
		 */
		hasValidPayment() {
			return this.businessObject && this.businessObject.payment && this.businessObject.payment !== null && typeof this.businessObject.payment === 'object';
		},
		...
		hasValidPaymentApply() {
			return this.businessObject && this.businessObject.paymentApply && this.businessObject.paymentApply !== null && typeof this.businessObject.paymentApply === 'object';
		},
