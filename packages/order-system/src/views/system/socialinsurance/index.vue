<template>
	<div class="app-container">
		...
		>
			...
			<el-table-column label="操作" align="center" class-name="small-padding fixed-width" fixed="right">
				<template slot-scope="scope">
					...
					<el-button v-hasPermi="['system:socialinsurance:remove']" size="mini" type="danger" @click="handleDelete(scope.row)">删除</el-button>
				</template>
			</el-table-column>
		</el-table>
		...
		<!-- 添加导入对话框 -->
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :title="upload.title" :visible.sync="upload.open" width="400px" append-to-body>
	...
	watch: {
		...
		'form.isRecruiting': {
			handler: function (newVal) {
				...
				newVal === '是' ? (this.form.isDepletion = '否') : (this.form.isDepletion = '是');
			},
			deep: true
		}
	},
