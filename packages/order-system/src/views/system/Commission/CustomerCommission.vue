<template>
	<div class="app-container">
		...
		>
			...
			<el-table-column v-if="columns[25].visible" show-overflow-tooltip label="实际客户佣金" align="center" prop="actualCustomerCommission" width="100">
				<template slot-scope="scope">
			...
			<el-table-column v-if="columns[27].visible" show-overflow-tooltip label="厂家佣金" align="center" prop="otherCommission" width="100">
				<template slot-scope="scope">
		...
		<!--    一键申请对话框-->
		<el-dialog :modal="false" v-dialogDrag v-dialogDragWidth v-dialogDragHeight :close-on-click-modal="false" title="客户佣金一键申请" :visible.sync="onceApplyVisible" width="1100px">
	...
	data() {
		return {
			...
			columns: [
				...
				{ key: 25, label: '实际客户佣金', visible: true },
				{ key: 26, label: '销售经理', visible: true },
				{ key: 27, label: '厂家佣金', visible: true },
