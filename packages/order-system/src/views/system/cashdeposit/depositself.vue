...
<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<right-toolbar :showSearch.sync="showSearch" :columns="columns" @queryTable="getList" table-name="views-system-cashdeposit-depositself-columns">
				<template #print>
					<el-col :span="1.5">
								...
								<el-col :span="3">
									...
									>
										<template #table-columns>
											<el-table-column :label="form.targetType === PUBLIC_DICT_TYPE.OTHER || form.targetType === PUBLIC_DICT_TYPE.EMPLOYEE ? '名称' : form.targetType" align="center" prop="companyName" />
