...
<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			...
			<right-toolbar :showSearch.sync="showSearch" :columns="columns" @queryTable="getList" table-name="views-system-cashdeposit-index-columns">
				<template #print>
					<el-col :span="1.5">
		...
		<template>
			<el-table id="printBox" v-loading="loading" v-horizontal-scroll="'always'" border :data="lendMoneyList" size="mini" :cell-style="() => ({ padding: '1px' })" @selection-change="handleSelectionChange">
				...
				<!-- 支付期货保证金时间 -->
				<el-table-column v-if="columns[10].visible" label="支付期货保证金时间" align="center" prop="futuresDate" show-overflow-tooltip />
