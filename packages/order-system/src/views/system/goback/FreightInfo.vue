		...
		<div class="search-area">
			<el-form id="top-search-form-item" :inline="true" :model="searchForm" ref="form" :rules="rules" class="demo-form-inline" size="mini" label-width="150">
				...
				<el-form-item>
					...
					<el-button type="success" @click="excelExport(['往来明细'], '运费明细')" size="mini">导出Excel</el-button>
				</el-form-item>
			</el-form>
		</div>
...
import { moduleNames, PUBLIC_DICT_TYPE, TableName, getOrAdvancedModule } from '@/api/tool/enums';
