...
<template>
	<div class="app-container">
		...
		<el-row :gutter="10" class="mb8">
			<right-toolbar :columns="columns" @queryTable="getList" table-name="views-system-statement-companysummarygive-columns">
				<template #print>
					<el-col :span="1.5">
		...
		<virtual-scroll ref="virtualScroll" :data="tableData" :item-size="30" key-prop="_vid" @change="tableDataAppendChange">
			<template slot-scope="{ headerCellFixedStyle, cellFixedStyle }">
				...
				>
					...
					<el-table-column v-if="columns[11] && columns[11].visible" show-overflow-tooltip label="本月欠款金额" align="center" prop="amountOwedThisMonth" width="140">
						<template slot-scope="scope">
