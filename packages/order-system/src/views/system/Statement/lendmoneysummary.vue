...
<template>
	<div class="app-container">
		...
		<hr color="#e6e6e6" />
		<el-row style="font-weight: bold; font-size: 20px; margin: 0 30px">员工或外面公司在我公司借款管理台账</el-row>
		<el-row :gutter="10" class="mb8">
			<right-toolbar :showSearch.sync="showSearch" :columns="columns" @queryTable="getList" table-name="views-system-statement-lendmoneysummary-columns">
				<template #print>
					<el-col :span="1.5">
